        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    <span class="sr-only">Toggle navigation</span> Ano <i class="fa fa-bars"></i>
                </button>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="menu.jsp">Año</a>
                    </li>
                    <li class="page-scroll">
                        <a href="mes.jsp">Mes</a>
                    </li>
                    <li class="page-scroll">
                        <a href="dia.jsp">Dia</a>
                    </li>
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <li class="page-scroll">
                                    <a href="modifinar.jsp">Evento de ejemplo 1</a>
                                </li>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <li class="page-scroll">
                                    <a href="modifinar.jsp">Evento de ejemplo 2</a>                                    
                                </li>
                            </div>
                        </div>                        
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <li class="page-scroll">
                                    <a href="modifinar.jsp">Evento de ejemplo 3</a>
                                </li>
                            </div>
                        </div>                         
                    </form>
