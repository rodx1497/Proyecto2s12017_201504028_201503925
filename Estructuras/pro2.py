...
#print (md.obtenerEventosMes("Junio"))
print (md.obtenerEventosYear("2020"))
"""
...
""
ld.buscar("Pedro Juarez").insertar("2017","TestFINAL","4","Make the Conection")
ld.buscar("Pedro Juarez").generarMatriz()
ld.buscar("Pedro Juarez").Grafica_Hash_Dia_Especifico("2017","TestFINAL","4")
ld.imprimir()
